...
destructible_walls = [pygame.Rect(game_area_x + i * 50, 450, 50, 50) for i in range((game_area_width // 50))]
...
while True:
    ...
    count_text = font.render(str(break_limit - break_count), True, (255, 255, 255))

    screen.blit(count_text, (screen_width - 50, 10))  # 오른쪽 위에 숫자만 표시
